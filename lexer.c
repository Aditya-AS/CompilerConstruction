...
int isDelim(char c){
	...
	if(c == '\n' || c == ' ' ||c == ':' ||c == ';' ||c == '+' ||c == '-' ||c == '/' ||c == '*' ||c == '[' 
	    ...
	    || c=='.' || c == '>' || c=='<' || c=='=' || c==EOF || c=='!' || c=='?' || c=='|' || c=='{' || c=='}'

	    || c=='^' || c=='`' || c == '\v' || c=='(' || c==')')return TRUE;
	else return FALSE;
...
tokenInfo* getNextToken(FILE* fp){
	//printf("CURR FORWARD IS ----------->>>>11111111 %c\n",*forward);
	...
	lexeme_begin = forward;
	// printf("%c\n",*forward);
	//printf("CURR FORWARD IS ----------->>>>2222222222 %c\n",*forward);
	while(curr_token == NULL){
			//printf("CURR FORWARD IS ----------->>>>333333333 %s \t %d\n",(*forward=='\0'?"SSSS":"NNNNN"),curr_state);
			switch(*forward)
			{
				//printf("CURR FORWARD IS ----------->>>> %c\n",*forward);
				case EOF:
